...
This project is indexed by GitNexus as **TokenArena** (5202 symbols, 10364 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
